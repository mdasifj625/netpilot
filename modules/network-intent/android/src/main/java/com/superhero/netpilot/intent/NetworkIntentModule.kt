...
class NetworkIntentModule : Module() {
  ...
  private fun tryLaunchRadioInfo(): Boolean {
    ...
    val samsungIntents = listOf(
      "Samsung Hidden Network Settings" to Intent().apply {
      ...
      "Samsung Band Selection" to Intent().apply {
    ...
    try {
      ...
      val dialIntent = Intent(Intent.ACTION_DIAL, android.net.Uri.parse("tel:$encodedCode")).apply {
        addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
      }
